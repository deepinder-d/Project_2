...
function chkbtn() {
    ...
    // if checkbox is clicked add exercise button will show
    if (checkedCount > 0) {
...
var selectedExercises = gymExercises.filter(function (exercise) {
    return exercise.level == selectedOption;
})
